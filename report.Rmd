...
getAUCs <- function(d) 
unlist(lapply(1:9,function(i) get.auc(get.rank(markers[[i]], get.generank(d[[i]])))))
getAUCmat <- function(d) 
lapply(1:9,function(i){unlist(lapply(1:6,function(j) get.auc(get.rank(markers[[i]], get.generank(d[[i]][[j]])))))})
```
